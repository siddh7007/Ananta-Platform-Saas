...
--
-- Name: bom_processing_jobs bom_processing_jobs_bom_id_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.bom_processing_jobs
    ADD CONSTRAINT bom_processing_jobs_bom_id_unique UNIQUE (bom_id);
