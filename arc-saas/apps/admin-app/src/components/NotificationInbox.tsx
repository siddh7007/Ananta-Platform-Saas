...
const NOVU_APP_IDENTIFIER = import.meta.env.VITE_NOVU_APP_IDENTIFIER || 'tGSrzvVXp4mm';
const NOVU_BACKEND_URL = import.meta.env.VITE_NOVU_BACKEND_URL || 'http://localhost:13100';
const NOVU_SOCKET_URL = import.meta.env.VITE_NOVU_SOCKET_URL || 'http://localhost:13101';
