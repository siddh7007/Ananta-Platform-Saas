...
export namespace TemporalBindings {
  export const CLIENT = BindingKey.create<TemporalClient>(
    'arc-saas.temporal.client',
  );
  export const CONFIG = BindingKey.create<TemporalConfig>(
    'arc-saas.temporal.config',
  );
  export const ENABLED = BindingKey.create<boolean>(
    'arc-saas.temporal.enabled',
  );
}
