...
export async function setupApplication(
  ...
  // Setup AuditLoggerService mock AFTER boot to override the auto-discovered service
  setupAuditLoggerMock(app);
...
/**
 * Mock AuditLoggerService for tests
 * Returns a no-op implementation that doesn't require the AuditLogRepository
 */
function setupAuditLoggerMock(app: RestApplication) {
  const mockAuditLog = {
    id: 'test-audit-id',
    action: 'test',
    actorId: 'test',
  ...
  const mockService: Partial<AuditLoggerService> = {
    log: async () => mockAuditLog as any,
    logTenantCreated: async () => mockAuditLog as any,
    logTenantUpdated: async () => mockAuditLog as any,
    logTenantDeleted: async () => mockAuditLog as any,
    logTenantProvisioned: async () => mockAuditLog as any,
    logLeadCreated: async () => mockAuditLog as any,
    logLeadUpdated: async () => mockAuditLog as any,
    logLeadDeleted: async () => mockAuditLog as any,
    logLeadVerified: async () => mockAuditLog as any,
    logLeadConverted: async () => mockAuditLog as any,
    logSubscriptionCreated: async () => mockAuditLog as any,
    logSubscriptionUpdated: async () => mockAuditLog as any,
    logSubscriptionCancelled: async () => mockAuditLog as any,
    logSubscriptionPlanChanged: async () => mockAuditLog as any,
    logSettingCreated: async () => mockAuditLog as any,
    logSettingUpdated: async () => mockAuditLog as any,
    logSettingDeleted: async () => mockAuditLog as any,
    logSettingsBulkUpdated: async () => mockAuditLog as any,
    logInvoiceCreated: async () => mockAuditLog as any,
    logInvoiceUpdated: async () => mockAuditLog as any,
    logInvoiceDeleted: async () => mockAuditLog as any,
    logUserCreated: async () => mockAuditLog as any,
    logUserUpdated: async () => mockAuditLog as any,
    logUserDeleted: async () => mockAuditLog as any,
    logUserSuspended: async () => mockAuditLog as any,
    logUserActivated: async () => mockAuditLog as any,
    logRoleAssigned: async () => mockAuditLog as any,
    logRoleRevoked: async () => mockAuditLog as any,
  };

  // Unbind any existing binding and rebind with our mock
  // The @service(AuditLoggerService) decorator looks for bindings with
  // SERVICE_INTERFACE tag set to the class itself (not a string)
  const bindingKey = `services.${AuditLoggerService.name}`;
  if (app.isBound(bindingKey)) {
    app.unbind(bindingKey);
  }
  app
    .bind(bindingKey)
    .to(mockService)
    .tag({[CoreTags.SERVICE_INTERFACE]: AuditLoggerService})
    .inScope(BindingScope.SINGLETON);
}
