          ...
          <Card sx={{ height: '100%' }}>
            <CardContent>
              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
                ...
                <Button size="small" onClick={fetchJobs} disabled={loading}>
                  <RefreshIcon />
                </Button>
              </Box>
                  ...
                  {filteredJobs.map(job => (
                    <Paper
                      ...
                      sx={{
                        ...
                        mb: 1,
                        cursor: 'pointer',
                        backgroundColor: selectedJobId === job.job_id ? '#e3f2fd' : 'transparent',
                        border: selectedJobId === job.job_id ? '2px solid #1976d2' : '1px solid #e0e0e0',
                    ...
                    <TableBody>
                      {lineItems.map(item => (
                        <TableRow
                          ...
                          sx={{
                            cursor: 'pointer',
                            backgroundColor: selectedLineId === item.line_id ? '#e3f2fd' : 'transparent',
