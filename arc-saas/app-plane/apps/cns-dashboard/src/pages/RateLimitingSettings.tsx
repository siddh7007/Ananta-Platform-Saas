...
import { getAdminAuthHeaders } from '../config/api';
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" gutterBottom>
        ⏱️ Enrichment Rate Limiting Settings
      </Typography>

      <Typography variant="body2" color="text.secondary" sx={{ mb: 3 }}>
        Configure delays between component processing to prevent API rate limiting errors.
        Changes take effect immediately for new enrichment workflows.
      </Typography>
