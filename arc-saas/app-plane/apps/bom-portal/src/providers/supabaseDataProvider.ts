...
if (!SUPABASE_URL) {
  console.error('[SupabaseDataProvider] VITE_SUPABASE_URL is not set. Please configure it in .env');
}

const SUPABASE_ANON_KEY = import.meta.env.VITE_SUPABASE_ANON_KEY;
if (!SUPABASE_ANON_KEY) {
  console.error('[SupabaseDataProvider] VITE_SUPABASE_ANON_KEY is not set. Please configure it in .env');
}
