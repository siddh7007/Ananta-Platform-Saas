...
import { AccessibleField, AccessibleFieldset } from '../components/ui';
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                {/* Logo Upload */}
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 3, mt: 2 }} role="group" aria-labelledby="logo-upload-label">
                  <Avatar
                  ...
                  <Box sx={{ ml: 2 }}>
                    <Typography id="logo-upload-label" variant="body2" fontWeight={500} sx={{ mb: 1 }}>
                      Organization Logo
                    </Typography>
                    <input
                    ...
                    <label htmlFor="logo-upload">
                      <Button
                        ...
                        disabled={!isOrgAdmin}
                        aria-label="Upload organization logo image"
                      >
                        Upload Logo
                      </Button>
                    </label>
                    <Typography id="logo-upload-hint" variant="caption" display="block" sx={{ mt: 1 }} color="text.secondary">
                      Recommended: 512x512px, max 2MB (JPEG, PNG, GIF, or WebP)
                    </Typography>
                  </Box>
                </Box>
                    ...
                    InputProps={{
                      ...
                      endAdornment: orgSlug.length >= 3 && (
                        <InputAdornment position="end">
                          {slugChecking ? (
                            <CircularProgress size={20} aria-label="Checking slug availability" />
                          ) : slugAvailable === true ? (
                            <CheckCircleIcon color="success" aria-label="Slug is available" />
                          ) : slugAvailable === false ? (
                            <ErrorIcon color="error" aria-label="Slug is not available" />
                          ) : null}
                        </InputAdornment>
                      ),
                    }}
                ...
                <AccessibleField
                  label="Email"
                  hint="Primary contact email for your organization"
                  error={orgEmailError || undefined}
                >
                  <TextField
                    type="email"
                    value={orgEmail}
                ...
                <AccessibleField
                  label="Address"
                  hint="Organization mailing address"
                >
                  <TextField
                    value={orgAddress}
          ...
          <Grid item xs={12} md={6}>
            <Card>
              <CardContent>
                ...
                <AccessibleField
                  label="Billing Email"
                  hint="Email address for billing notifications and invoices"
                  error={billingEmailError || undefined}
                >
                  <TextField
                    type="email"
                    value={billingEmail}
