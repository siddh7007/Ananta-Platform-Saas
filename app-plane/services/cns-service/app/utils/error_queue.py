...
class ErrorQueue:
    ...
    def _store_error_in_database(self, error_record: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # Use generator properly as context manager
            for db in dual_db.get_session("supabase"):
                query = text("""
                ...
                db.commit()
                # Session automatically closed when loop ends (generator finally block)
    ...
    def get_pending_retries(self, limit: int = 10) -> list:
        ...
        try:
            ...
            for db in dual_db.get_session("supabase"):
                ...
                # Session automatically closed when loop ends
    ...
    def mark_resolved(self, component_id: str, bom_id: str) -> None:
        ...
        try:
            ...
            # Update database using generator properly as context manager
            dual_db = get_dual_database()
            for db in dual_db.get_session("supabase"):
                query = text("""
                ...
                db.commit()
                logger.info(f"[OK] Error marked resolved: {component_id}")
                # Session automatically closed when loop ends
    ...
    def mark_abandoned(self, component_id: str, bom_id: str) -> None:
        ...
        try:
            ...
            for db in dual_db.get_session("supabase"):
                ...
                db.commit()
                logger.info(f"[OK] Error marked abandoned: {component_id}")
                # Session automatically closed when loop ends
