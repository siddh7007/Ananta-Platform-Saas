...
export const ComponentEnrichmentDetail: React.FC = () => {
  ...
  // Load enrichment detail - wrapped in useCallback for proper dependency tracking
  const loadEnrichmentDetail = useCallback(async () => {
    if (!mpn) return;
  ...
  // Load enrichment detail when mpn changes
  useEffect(() => {
