...
export default function AsyncAutocomplete({
  ...
  // Clear options when disabled changes or loadOptions function reference changes
  // This ensures stale options from a previous context aren't shown
  useEffect(() => {
    if (disabled) {
      setOptions([]);
      setInputValue('');
  ...
  // Clear options when loadOptions changes (e.g., when parent context changes)
  useEffect(() => {
    setOptions([]);
  }, [loadOptions]);
