...
// Portal hashes that should redirect to /customer/portal
const PORTAL_HASHES = ['#boms', '#components', '#risks'];
...
export const Dashboard: React.FC = () => {
  ...
  // Check for portal-related hashes at root and redirect
  useEffect(() => {
    const hash = window.location.hash;
    if (PORTAL_HASHES.includes(hash)) {
      // Redirect to customer portal with the hash
      navigate(`/customer/portal${hash}`, { replace: true });
    }
  }, [navigate]);
