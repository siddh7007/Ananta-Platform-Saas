 ...
 *
 * Features:
 * - STRICT platform admin enforcement (configurable via VITE_DEFAULT_ORG_ID)
...
export const auth0AuthProvider = createAuth0AuthProvider({
  ...
  platformOrgId: import.meta.env.VITE_DEFAULT_ORG_ID || 'org_oNtVXvVrzXz1ubua', // REQUIRED - Platform admin organization
