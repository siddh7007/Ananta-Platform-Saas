    ...
    <Stack direction="row" spacing={0.5} alignItems="center">
      <Tooltip title={`${enriched_items} enriched`}>
        <Chip
          ...
          size="small"
          sx={{
            bgcolor: `${enrichmentStatusColors.completed}15`,
      ...
      {failed_items > 0 && (
        <Tooltip title={`${failed_items} failed`}>
          <Chip
            ...
            size="small"
            sx={{
              bgcolor: `${enrichmentStatusColors.failed}15`,
  ...
  return (
    <Box p={3}>
      ...
      <Dialog
        ...
        onClose={() => setDeleteDialog({ open: false, uploadId: null })}
        aria-labelledby="delete-dialog-title"
        aria-describedby="delete-dialog-description"
      >
        <DialogTitle id="delete-dialog-title">Delete Enrichment Job?</DialogTitle>
        <DialogContent>
