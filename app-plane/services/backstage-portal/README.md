...
Customer Portal (Port 27510)
    ↓
Supabase Stack (Ports 27700-27703)
    ├─ Kong API Gateway (27700)
    ├─ PostgreSQL (27701)
    ├─ Auth Service
    ├─ REST API (PostgREST)
    ├─ Realtime
...
docker compose -f docker-compose.customer-portal.yml up -d
```
...
```bash
VITE_SUPABASE_URL=http://localhost:27700
VITE_SUPABASE_ANON_KEY=your-anon-key-here

# CNS (Component Normalization Service) base URL used by BOM tools
