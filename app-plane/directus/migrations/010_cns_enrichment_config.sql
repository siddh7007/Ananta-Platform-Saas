...
GRANT SELECT, INSERT, UPDATE ON cns_enrichment_config TO service_role;
GRANT SELECT, INSERT ON cns_enrichment_audit TO service_role;
GRANT SELECT ON cns_cost_tracking TO service_role;
GRANT USAGE ON SEQUENCE cns_enrichment_config_id_seq TO service_role;
GRANT USAGE ON SEQUENCE cns_enrichment_audit_id_seq TO service_role;

-- Grant to authenticated users (read-only for config, no audit access)
GRANT SELECT ON cns_enrichment_config TO authenticated;
